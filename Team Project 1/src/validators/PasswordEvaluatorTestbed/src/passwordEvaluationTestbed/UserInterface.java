...
public class UserInterface {
	 ...
	 * These assignments
	 * determine the location, size, font, color, and change and event handlers for
	 * each GUI object.
	 */
	...
	private void performEvaluation() {
		...
		if (inputText.isEmpty())
			...
			} else if (PasswordEvaluator.upperCase && PasswordEvaluator.lowerCase &&
					PasswordEvaluator.numericChar && PasswordEvaluator.specialChar &&
					PasswordEvaluator.longEnough) {
