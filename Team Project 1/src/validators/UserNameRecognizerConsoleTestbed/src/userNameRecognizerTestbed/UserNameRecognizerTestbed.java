...
/*******
 * <p>
 * Title: UserNameRecognizerTestbed.
 * </p>
 * 
 * <p>
 * Description: A console terminal demonstration application
 * </p>
 * 
 * <p>
 ...
 * 
 * @version 1.00 2024-09-13 The mainline of a console terminal implementation of
 *          an UserName
 *          Recognizer testbed
 * 
 */
...
public class UserNameRecognizerTestbed {
	...
	public static void main(String[] args) {
		...
		// As long as there is a next line, read it in... Since the input is the
		// keyboard, this is always true
		while (keyboard.hasNextLine()) {
			...
			if (errMessage != "") {
				...
				System.out
						.println(inputLine.substring(0, UserNameRecognizer.userNameRecognizerIndexofError) + "\u21EB");
			} else {
