...
public class PasswordEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(2, "aaa", false);
		performTestCase(3, "6Aa<b!3c", false);
	...
	private static void displayEvaluation() {
		...
		if (!PasswordEvaluator.otherChar)
			System.out.println("No other characters - Satisfied");
		else
			System.out.println("No other characters - Not Satisfied");
	}
}
