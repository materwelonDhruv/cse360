...
public class PasswordEvaluator {
	 ...
	 * Graph.
	 * The code detailed design is based on a while loop with a cascade of if
	 * statements
	 * </p>
	 * 
	 * <p>
	...
	public static boolean otherChar = false; // boolean flag if unallowed character is found
	private static int charCounter; // The index/count of the current character
	 ...
	 * displays an up arrow
	 * at the point where an error should one be detected. This method is designed
	 * to be used to
	 * display the error message on the console terminal.
	 * 
	 * @param input       The input string
	 * @param charCounter The location where an error was found
	...
	public static String evaluatePassword(String input) {
		...
		if (otherChar)
			errMessage += "Only allowed characters; ";

		if (errMessage == "")
			return "";

		passwordIndexofError = charCounter;
		return errMessage + "condition(s) were not satisfied";
